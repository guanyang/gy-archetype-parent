...
import ${entity.rootPackage}.business.bo.${entity.className}Bo;
import ${entity.rootPackage}.business.dao.${entity.className}Mapper;
import ${entity.rootPackage}.business.model.${entity.className};
import ${entity.rootPackage}.business.model.${entity.className}Example;
