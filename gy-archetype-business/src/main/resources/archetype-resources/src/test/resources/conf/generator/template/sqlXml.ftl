...
<mapper namespace="${entity.tableName?upper_case}">
	<!-- 获取满足条件的记录数量 -->
	<select id="QUERY_FOR_COUNT" parameterType="${entity.rootPackage}.business.bo.${entity.className}Bo" resultType="java.lang.Integer">
  	   	SELECT 
  	   		COUNT(1)
	...
	<!-- 获取满足条件的记录列表 -->
	<select id="QUERY_FOR_LIST" parameterType="${entity.rootPackage}.business.bo.${entity.className}Bo" resultType="${entity.rootPackage}.business.model.${entity.className}">
		select
		<#list entity.properties as property>
